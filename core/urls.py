...
urlpatterns = [
    ...
    path('api/get_all_hospital_branches/', views.get_hospital_branches_json, name="all_hospital_branches"),
    ...
    path('api/get_all_users/', views.get_all_users, name="AllUsers"),
    path('allDepartments/', views.display_all_departments, name="all_departments"),
    ...
    path("api/send-emergency-link/", views.send_emergency_link, name="send_emergency_link"),
